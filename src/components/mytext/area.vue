  ...
  <span>
    <span @click="choseAdd()">
      <div class="fuqin">
        ...
        <input v-model="messagearea" class="areinput" placeholder="省市区选择">

        <img src="../../assets/my_icon_f@2x.png" alt class="areinputimg">
      </div>
    </span>
    <section class="showChose" v-show="showChose">
      <section class="address">
        <section class="title">
          <!-- <h4>居住地址</h4> -->
          <img src="../../assets/my_sh_icon_gb@2x.png" alt @click="closeAdd()" class="noneimg">
...
export default {
  ...
  methods: {
    ...
    getDistrictId: function (code, input, index) {
      ...
      this.messagearea = this.Province + " - " + this.City + " - " + this.District;
      // 选取市区选项之后关闭弹层
      this.showChose = false;
      this.sendValue(this.messagearea);
      this.$refs.selectUl.scrollTop = 0;
    },
...
.address .title .active {
  color: #f7a020;
  border-bottom: 0.02rem solid #f7a020;
}
.address ul .active {
  color: #f7a020;
}
